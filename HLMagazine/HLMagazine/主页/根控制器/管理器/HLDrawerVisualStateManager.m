...
@implementation HLDrawerVisualStateManager
+ (HLDrawerVisualStateManager *)sharedManager {
    static HLDrawerVisualStateManager *_sharedManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedManager = [[HLDrawerVisualStateManager alloc] init];
